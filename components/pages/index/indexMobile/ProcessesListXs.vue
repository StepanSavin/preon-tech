  ...
  <div class="process-xs bg-black py-10 text-white">
    <div class="px-6 mb-14">
      ...
      <p class="mt-2 leading-5 font-medium">
        ...
        processes for it solutions. Automated project management system gives
        the customer access to real-time reporting of all project details
      </p>
    </div>
    <div
      ...
      :key="process.title"
      class="pb-8"
      :class="`bg-process-bg-${index + 1}`"
    >
      <div
        class="process-xs__image-wrapper rounded-15 overflow-hidden relative"
      >
      ...
      <div class="px-6">
        ...
        <div class="flex gap-2 items-center mt-4" @click="handleClick(process)">
          <transition name="process-xs-text">
            <p
              :key="process.isDescriptionVisible"
          ...
          >
            <LazyImage
              :style="{
                transform: `rotate(${
                  process.isDescriptionVisible ? '180' : '0'
                }deg)`,
              }"
              width="11"
              height="11"
