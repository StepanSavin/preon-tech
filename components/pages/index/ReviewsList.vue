      ...
      <div class="flex items-center reviews__top-text">
        ...
        <div class="flex items-center">
          <p class="text-black leading-5 reviews__subtext">
            SMB, enterprise, and startup clients return to us because they’re<br />
      ...
      <div class="mt-10 md:mt-12 sm:mt-12 flex gap-4 items-center reviews__pagination">
        ...
        >
          <LazyImage
            width="14"
            height="14"
            src="index/reviews/arrow-left.svg"
          />
        </div>
        <div
          class="flex justify-center items-center w-8 h-8 rounded-full bg-white"
        >
          <LazyImage
            width="14"
            height="14"
            src="index/reviews/arrow-right.svg"
          />
        </div>
      </div>
            ...
            <div class="flex gap-8 md:gap-12 sm:gap-12 sm:flex-col md:flex-col">
              <div class="flex-1 relative">
                <div class="flex items-center gap-6">
                  ...
                  <div class="flex-1">
                    <p class="text-gray-5 text-xl leading-6 font-medium">
                      Olga Danilova
                    </p>
                ...
                <p class="mt-8 text-gray-6 text-xl leading-6">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                  Mauris, lectus euismod consequat eleifend. Odio arcu sagittis
                  pellentesque euismod tellus sed. Lorem ac sit feugiat tempor
                  consectetur nulla placerat urna. Proin morbi ultricies ornare
                  ornare aliquam a proin. Elementum, egestas vel, in. erat urna.
                  Proin morbi ultricies ornare ornare aliquam a proin.
                ...
                <div class="mt-2.5 flex gap-2 items-center md:hidden sm:hidden">
                  ...
                  >
                    <LazyImage
                      width="14"
                      height="14"
                      src="index/reviews/arrow-down.svg"
                    />
                  </div>
                </div>
                <LazyImage
...
export default {
  ...
  computed: {
    isVisible() {
      return this.$props.currentSection === 23
    },
  },
  watch: {
    currentSection(value) {
      if (value === 23) this.$emit('changeColor', '#FF9B80')
    },
  },
  methods: {
