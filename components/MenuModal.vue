  ...
  <div id="menuModal" class="fixed origin-top top-0 left-0 w-full h-screen z-10 bg-black menu-modal text-white overflow-hidden">
    ...
    >
      ...
      >
        ...
        />
        <div class="flex items-center gap-2 mt-16 cursor-pointer" @click="isChecked = !isChecked">
...
export default {
  ...
  data() {
    return {
      menu: ['Cases', 'Processes', 'Services & Solutions', 'Super Deals', 'Technologies', 'Career', 'Mission'],
      nameValue: '',
      emailValue: '',
      numberValue: '',
      isChecked: false,
